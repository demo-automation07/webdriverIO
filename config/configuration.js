...
export const allureReportDirectory = './report/allure';
export const jsonReportDirectory = './report/json_report';
export const timelineReportDirectory = './report/timeline_report';